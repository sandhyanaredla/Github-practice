...
public class Add_Method_Static {
 ...
 public void Add_jobs_Test() throws Exception  {
	  ...
	  Add_Method_Static.openChromeBrowser();
	  Add_Method_Static.OpenOrgangeHRM();
	  Add_Method_Static.Login();
	  Add_Method_Static.Add_Jobs();
	  Add_Method_Static.CloseBrowser();
